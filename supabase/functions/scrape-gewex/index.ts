...
Deno.serve(async (req) => {
  ...
  if (body.dry_run) return dryRunStream(supabase, IPO_ID, `${BASE}${LIST}`, parseEvents, 'Preview covers page 1 only — full run scrapes all pages and may find many more events.')
