...
export default async function IPOEventRegistryPage({ searchParams }: PageProps) {
  ...
  // Admin client — pending/cross-org data spans multiple orgs, same reasoning as Approvals
